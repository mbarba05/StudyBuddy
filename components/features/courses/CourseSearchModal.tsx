...
const CourseSearchModal = ({
                                ...
                                <>
                                    {profSearchResults.length > 0 && (
                                        <View className="mt-4">
                                            {profSearchResults.map((p) => (
                                                ...
                                                >
                                                    <Text className="text-colors-text font-semibold">{p.name}</Text>
                                                    <Ionicons
                                    ...
                                    {noResults && (
                                        <View className="mt-4 flex items-center">
                                            <Text className="text-colors-textSecondary mb-2">No matches found.</Text>
                                            <TouchableOpacity
    ...
    return (
        ...
        >
            <View className="p-5 flex-1 bg-colors-background">
                <SearchBar
                    autoCapitalize="characters"
                    autoCorrect={false}
