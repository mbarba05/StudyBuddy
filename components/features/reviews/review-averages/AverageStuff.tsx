...
import ProfessorSummaryBox from "../ProfessorSummaryBox";
...
export default function AverageStuff({ reviews, selectedCourseCode, profId, professorName }: Props) {
   ...
   */
    ...
    const showingAll = selectedCourseCode === null;
